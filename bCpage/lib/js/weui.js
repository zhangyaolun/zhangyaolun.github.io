...
!
                    ...
                    if ("" !== s) if (s.indexOf("{{") < 0) r.push({
                        ...
                        if (s.indexOf("{#") >= 0) {
                            var d, f = "",
                                ...
                                w = !1,
                                y = 0;
                            for (a = i + 1; a < o.length; a++) if (o[a].indexOf("{{#") >= 0 && y++, o[a].indexOf("{{/") >= 0 && y--, o[a].indexOf("{{#" + l) >= 0) f += o[a], w && (m += o[a]), v++;
            ...
            var a = function(t) {
                ...
                function o(t, o) {
                    ...
                    for (p = 0; p < c.length; p++) {
                        ...
                        if ("plain" !== h.type) {
                            var d, f;
                            if ("variable" === h.type && (d = a(h.contextName, l), u += "r += c(" + d + ", " + l + ");"), "helper" === h.type) if (h.helperName in s.helpers) f = r(h.contextName, l), u += "r += ($.Template7.helpers." + h.helperName + ").call(" + l + ", " + (f && f + ", ") + "{hash:" + JSON.stringify(h.hash) + ", data: data || {}, fn: " + e(h, o + 1) + ", inverse: " + n(h, o + 1) + ", root: ctx_1});";
                            else {
            ...
            a.prototype = {
                ...
                helpers: {
                    ...
                    each: function(n, i) {
                        ...
                        } else for (var o in n) r++, a += i.fn(n[o], {
                            key: o
                        });
    ...
    function(t, e, n, i) {
        ...
        function o(t, e, n) {
            ...
            else if (t.length !== i) for (a = 0; a < t.length;) e.call(n, t[a], a, t), a++;
    ...
    function(t) {
        ...
        t.toast = function(t, a, r) {
            ...
            var o, s = "weui-icon-success-no-circle",
                c = i.duration;
            "cancel" == a ? (o = "weui-toast_cancel", s = "weui-icon-cancel") : "forbidden" == a ? (o = "weui-toast--forbidden", s = "weui-icon-warn") : "text" == a ? o = "weui-toast--text" : "number" == typeof a && (c = a), e('<i class="' + s + ' weui-icon_toast"></i><p class="weui-toast_content">' + (t || "宸茬粡瀹屾垚") + "</p>", o), setTimeout(function() {
                n(r)
            }, c)
        ...
        i.prototype.initConfig = function() {
            ...
            if (!n) {
                ...
                if (this.config.multi) {
                    if (void 0 !== this.config.min && this.data.length < this.config.min) return t.toast("璇疯嚦灏戦€夋嫨" + this.config.min + "涓�", "text"), !1;
                    if (void 0 !== this.config.max && this.data.length > this.config.max) return t.toast("鏈€澶氬彧鑳介€夋嫨" + this.config.max + "涓�", "text"), !1
                }
            }
    ...
    function(t) {
        ...
        i.prototype = {
            ...
            parse: function(t) {
                ...
                return e[0].split(/\D/).concat(e[1].split(/:|鏃秥鍒唡绉�/)).filter(function(t) {
                    return !!t
                })
            }
        }
