var commentJs = {
    /*首页头部*/
    homeHader: function () {
        $('.head-fixed').html('<div class="head-ser"><div class="logo"><img src="../../images/logo.png" alt="" class="site_logo"></div><a href="search.html" class="header-inps"><i class="icon"></i><span class="search-input" id="keyword">建行信用卡专享购物平台/全场12期免息</span><div class="submit-btn">搜索</div></a></div>');
    },
    /*尾部*/
    ...
    areaSelected: function(options) {//城市地址选择
        ...
        function _getAreaList() {
            $.ajax({//获取区域列表
                type:'get',
                url:'http://paycenter.g-town.com.cn//index.php?ctl=Base_District&met=district&typ=json&pid=0',
                dataType:'json',
                async:false,
