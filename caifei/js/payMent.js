...
$('.title_price').html((data.discountRate*100).toFixed(0)+'折');			
...
/*匿名评论
 * $('.pay_bottom img').on('click',function(){
	if($('.pay_bottom img').hasClass('one')){
		$('.pay_bottom img').removeClass('one');
		$('.pay_bottom img').attr('src','../img/Unchecked.png');
	}else{
		$('.pay_bottom img').addClass('one');
		$('.pay_bottom img').attr('src','../img/Selected.png');
	}
});*/
