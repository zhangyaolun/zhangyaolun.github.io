<template>
  <div>
    ...
    <div class="pass" v-if="ispass">
      <input type="password" placeholder="原登录密码" class="password1" v-model="oldPwd" v-on:value="oldPwd">
      <input type="password" placeholder="新登录密码" class="password2" v-model="newPwd" v-on:value="newPwd">
    </div>
    <div class="pass" v-if="isemail">
      <input type="text" placeholder="请输入邮箱" v-model="userEmail" v-on:value="userEmail" class="email">
    </div>
    <div class="pass" v-if="isname">
      <input type="text" placeholder="请输入昵称" v-model="nickName" v-on:value="nickName" class="name">
    </div>
    <div class="pass" v-if="ismobile">
      <input type="text" placeholder="请输入手机" v-model="mobile" v-on:value="mobile" class="name">
    </div>
  </div>
