<template>
    <div class="container" v-pageLoading="loading">
        <template-query :goodsStatus="goodsStatus" :info.sync="info" @add="add" @query="query"/>
        <template-list :goodsStatus="goodsStatus" :list-query="info" :table-data="list" @mod="mod" @query="query"/>
