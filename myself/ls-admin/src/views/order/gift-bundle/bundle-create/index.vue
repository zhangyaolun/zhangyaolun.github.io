<template>
  <div class="view-order-system_bundle-create" v-loading="loading">
    ...
    <bundle-create-btn @createBundle="createBundle" />
  </div>
</template>
...
import bundleCreateBtn from './bundle-create-btn.vue'
import { encodeTextAreaString } from '@/utils/validate'
  ...
  methods: {
    createBundle() {
      ...
      if (flag1 && flag2) {
        ...
        this.$api.orderGiftBundle.store(bundles).then(res => {
