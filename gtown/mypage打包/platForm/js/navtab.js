layui.define(['element'], function(exports){
   var  element = layui.element(),
        ...
        changeTab = function () {
          ...
          if($liWidth>ELEM.titleBox.width()){
            // 超出显示
            $(".layui-tab .pressKey").show();
            var $left =ELEM.titleBox.width() - $liWidth;
            $(".layui-tab-title").css("left",$left+"px");
            // 移除span
            $('.layui-tab-title span.layui-tab-bar').remove();

          }else {
            // 隐藏
            $(".layui-tab .pressKey").hide();
