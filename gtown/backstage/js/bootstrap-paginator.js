...
(function ($) {
    ...
    BootstrapPaginator.prototype = {
        ...
        render: function () {
            ...
            var itemTz = $("<span>跳转</span>").unbind('click').on("click",null,{type: 'jump'},$.proxy(this.onPageItemJumped, this));//绑定点击事件
        ...
        buildPageItem: function (type, page) {
            ...
            itemContent.addClass(itemContentClass).html(text).unbind('click').on("click", null, {type: type, page: page}, $.proxy(this.onPageItemClicked, this));
