...
var Main = function() {"use strict";
	...
	var setColorScheme = function() {
		$('.icons-color a').on('click', function() {
			...
			console.log($('#skin_color').attr("href"))
			switch ($(this).attr('id')) {
				case "style3":
	...
	var channelAddClick = function() {
		$('.button_newAdd').on('click',function(){
			$('.elasticDiv').show().addClass("animated flipInX").on('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function() {
